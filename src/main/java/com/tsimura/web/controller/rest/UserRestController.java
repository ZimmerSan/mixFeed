...
public class UserRestController {
    ...
    List<UserXtrCounters> getUserActiveFriends(@PathVariable Integer userId){
    ...
    List<Photo> getUserPhotos(@PathVariable Integer userId){
        return photoService.findByUserId(userId);
    }

    @GetMapping("/{userId}/photos/count")
    Integer getUserPhotosCount(@PathVariable Integer userId){
        return photoService.countByUserId(userId);
    }

    @GetMapping("/{userId}/groups")
    List<Photo> getUserGroups(@PathVariable Integer userId){
        return photoService.findByUserId(userId);
    }

    @GetMapping("/{userId}/groups/count")
    Integer getUserGroupsCount(@PathVariable Integer userId){
